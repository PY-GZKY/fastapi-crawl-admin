...
# 总项目数量/总任务数量
def global_count(*, request: Request, db: Session = Depends(get_db),
...
router.add_api_route(methods=['GET'], path="/global/count", endpoint=global_count, summary="全局统计")
router.add_api_route(methods=['GET'], path="/global/system", endpoint=system_params, summary="系统信息")
router.add_api_route(methods=['GET'], path="/global/redis", endpoint=redis_param, summary="redis参数")
router.add_api_route(methods=['GET'], path="/global/mongodb", endpoint=mongo_param, summary="mongodb参数")
